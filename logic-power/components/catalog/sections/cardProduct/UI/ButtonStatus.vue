<template>
  ...
  >
    <!--<div class="button-status__images">
      <SvgIcon
        class="button-status__image in-stock"
        :icon="icons['in-stock']"
      />
      <SvgIcon
        class="button-status__image not-available"
        :icon="icons['not-available']"
      />
      <SvgIcon class="button-status__image ends" :icon="icons['ends']" />
      <SvgIcon
        class="button-status__image pre-order"
        :icon="icons['pre-order']"
      />
    </div>-->
...
const { status, changeView, inactive } = defineProps([
  'status',
  'changeView',
  'inactive',
]);
